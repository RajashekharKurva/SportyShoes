    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="login.jsp" >CustomerLogin</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="/JSP/registration.jsp" target="_blank" >CustomerSignUp</a>
          </li>
...
<div class="container">
  <h1 align="center" style="color: #20c497;" >Customer login</h1>
  <form action="login">
    <div class="mb-3">
